...
public class MeshCombineUtility {
	...
	// NOTE: The 'generateStrips' parameter is kept for API compatibility but is ignored.
	// Triangle strips (GetTriangleStrip / SetTriangleStrip) were removed in Unity 5.
	// All meshes are now combined using standard triangle lists.
